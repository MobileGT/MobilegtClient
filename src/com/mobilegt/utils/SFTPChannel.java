...
//        LOG.debug("Session created.");
        Log.i("connect","Session creacted");
        if (ftpPassword != null) {
...
//                + ", returning: " + channel);
        Log.i("Connect","mobilegt Connected successfully to ftpHost = " + ftpHost + ",as ftpUserName = " + ftpUserName + ", returning: " + channel);
        } catch (JSchException e) {
			// TODO Auto-generated catch block
			Log.e("error",e.toString()+"mobilegt");
		} catch(Exception e){
			Log.e("error",e.toString()+"mobilegt");
		}
